const  XBOT = 'XONTOL BOT'; // Nama Bot Whatsapp
...
const aktif = 'Tergantung Izin Ortu :)'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/DoQvYLCm9SEKpUgHOZwt2D'; // OFFICIAL GRUP LU 1
const youtube = '(PercumaGwKasihLinkYtNyaLagianJugaGkBakalanDiSubrek)'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285226087964:+62 852-2260-7964\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.sendMessage(id, ' Thanks Telah Menggunakan BOT *XONTOL BOT* , Follow Instagram Mimin Yah� : https://instagram.com/@IndraFajri64' ,MessageType.text);
}
else if (text == '#info'){
conn.sendMessage(id, ' Thanks Telah Menggunakan BOT *XONTOL BOT* , Follow Instagram Mimin Yah� : https://instagram.com/@IndraFajri64' ,MessageType.text);
}
